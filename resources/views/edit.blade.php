...
<div class="mb3">
    ...
    <div>
        <input class="form-control" placeholder="Zapatos Marrones de Cuero" required="required" name="nombre" type="text" id="nombre" value="{{ $producto->nombre }}">
    </div>
</div>
...
<div class="mb3">
    ...
    <div>
        <input class="form-control" placeholder="4.50" required="required" name="precio" type="text" id="precio" value="{{ $producto->precio }}">
    </div>
</div>
...
<div class="mb3">
    ...
    <div>
        <input class="form-control" placeholder="40" required="required" name="stock" type="text" id="stock" value="{{ $producto->stock }}">
    </div>
</div>
